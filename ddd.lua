			...
			-- init 
				...
				function cfg.set(input)
					...
					if cfg.name then 
						...
						-- If a parent toggle flag exists, check if it's active
						if parentToggleFlag ~= cfg.flag and flags[parentToggleFlag] then
							parentToggleActive = flags[parentToggleFlag].active or false
						end
